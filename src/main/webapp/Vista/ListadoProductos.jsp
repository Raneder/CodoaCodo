	...
	<div class="container">
		...
		<table class="table table-primary table-striped text-center">
			...
			<tbody>
				...
				try{
					// traer el archivo o clase conexion para conectarse a la base de datos
					Conexion conexion = new Conexion();

					// conecto a la db y devuelve un objeto statement que es una instancia de database
					Statement st = conexion.conectar();

					// le hago consultas sql, traigo la tabla productos
					...
					while (rs.next()) {
						...
						out.println("<td>");
						out.println(rs.getDouble("precio"));
						out.println("</td>");
